...
SELECT countries.name as Name, count(*) as Cities
FROM cities
LEFT JOIN countries
...
SELECT countries.name as Name, cities.name AS CitiesName, cities.district as District, cities.population as Population
FROM countries
LEFT JOIN cities
